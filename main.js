...
// TODO: write your code below this line
function sumGreaterFive(myArray) {
    let sum = 0
...
// TODO: write your code below this line
let interest = information["interest"]
let outdoor = interest["outdoor"]
let hiking = outdoor[0]
let hiking2 = hiking["hiking"]
let Menengai = hiking2[2]
console.log(Menengai)
...
// TODO: write your code below this line
let anagramFunc = (firstString, secondString) => {
...
// TODO: write your code below this line
let palindromeFunc = (parameter) => {
    let start = parameter.substring(0, Math.floor(parameter.length / 2)).toLowerCase()
    let end = parameter.substring(parameter.length - Math.floor(parameter.length / 2)).toLowerCase()
    let flip = end.split('').reverse().join('')
    palindrome = start === flip
    return palindrome
}
...
// TODO: write your code below this line
let baseBallPointer = (score => {
    let points = []
    let last, secondlast
    score.forEach(element => {
        if (element === "C") {
            points = score.slice(0, score.indexOf("C"))
            points.pop()
        } else if (element === "D") {
            last = points.pop()
            points.push(last, last * 2)

        } else if (element === "+") {
            last = points.pop()
            secondlast = points.pop()
            points.push(secondlast, last, secondlast + last)

        } else {
            points.push(element * 1)
        }
    });
    return points.reduce((total, num) => {
        return total + num
    })
})
